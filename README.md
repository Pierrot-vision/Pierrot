...
- **참여·조언·채용등의 관련 모든 문의는 언제나 환영입니다.**
...
미국, 특히 중국 회사들은 꾸준히 괜찮은 모델을 내놓는데 "왜 우리나라 회사들은 잘 시도하지 않을까?" 하는 궁금증이 있었습니다. 거기서 한 걸음 더 나아가 "스크래치(from scratch) 학습이 정말 그렇게 어려운 일일까?" 가 궁금해졌고, 무엇보다 — 나도 한 번 바닥부터 직접 학습해 보고 싶다는 욕구가 컸습니다.

제약은 많았습니다. 회사 일도 바빴고, 개인 시간을 따로 쪼개야 했습니다. 가장 큰 벽은 역시 비용이었습니다. 고비용의 서버를 개인이 감당해야 한다는 점이 제일 큰 고민이었죠. 그래도 "일단 해보자" 하고 시작한 프로젝트입니다.

아직 진행 중이지만, 지금까지의 결론은 이렇습니다. **GPU 와 학습셋 환경만 갖춰진다면** (이게 결코 쉬운 조건이 아니라는 건 잘 압니다), 최고는 아니더라도 — 제가 참 좋아하는 — **FLUX.2 Klein 4B** 처럼 작으면서도 실용적인 고성능 모델을 충분히 만들 수 있겠다는 확신이 생겼습니다.
