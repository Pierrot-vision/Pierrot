...
<p align="center">
  <b>A one-person experimental image-generation model project</b>
</p>
...
This project is under the **PIERROT Non-Commercial Research License (v1.0)** — see [LICENSE](LICENSE) for details.
...
- Redistributions / derivatives must **keep the same license + attribution** ([Pierrot-vision/Pierrot](https://github.com/Pierrot-vision/Pierrot))
